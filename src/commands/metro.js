    ...
    https.get(get_options, (resp) => {
      ...
      resp.on("end", () => {
        ...
        embed
          ...
          .setAuthor({
            name: "WMATA",
            iconURL:
              "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/WMATA_Metro_Logo.svg/800px-WMATA_Metro_Logo.svg.png",
          })
          .setTimestamp()
      ...
      resp.on("error", (err) => {
        ...
        return interaction.editReply({
          content: "This service is not available at this time.",
    ...
    https.get(get_options, (resp) => {
      ...
      resp.on("end", () => {
        ...
        if (stations.length === 0) {
          return interaction.editReply({
            content: `No info was found for ${station}`,
            flags: MessageFlags.Ephemeral,
          })
        }
